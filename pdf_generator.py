...
def gen_partner_pdf(
    ...
    *,
    ...
    if hide_price:
        ...
        prod_labels = ["JANコード", "商品名", "規格", "配送荷姿", quantity_label]
    else:
        prod_cols = [
            (0, 30), (30, 72), (102, 20), (122, 18),
            (140, 18), (158, 22), (180, 22), (202, uw_mm - 202),
        ]
        prod_labels = ["JANコード", "商品名", "規格", "配送荷姿", "1袋単価", "CS単価", quantity_label, "金額"]
    prod_hdr_h = 22
    prod_row_h = 28
...
def gen_nomura_pdf(order, items, staff_name="伊藤"):
    """野村不動産ライフ＆スポーツ㈱ 向け 発注書PDF生成 (バラ袋単位)"""
